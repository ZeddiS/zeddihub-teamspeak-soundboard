...
| TS3 client | API | File |
|---|---|---|
| 3.5.0 | 23 | `Soundboard-v1.1.1-TS3-3.5.0-api23.ts3_plugin` |
| 3.5.1 - 3.5.5 | 24 | `Soundboard-v1.1.1-TS3-3.5.1-3.5.5-api24.ts3_plugin` |
| **3.5.6** | **25** | **`Soundboard-v1.1.1-TS3-3.5.6-api25.ts3_plugin`** |
| 3.6.x and newer | 26 | `Soundboard-v1.1.1-TS3-3.6+-api26.ts3_plugin` |
